  ...
  return (
    <div className="w-full bg-white md:px-10" ref={containerRef}>
        <div className="mx-auto py-20 px-4 md:px-8 lg:px-10">
            <h5 className="text-4xl bg-gradient-to-br from-blue-500 to-purple-900 bg-clip-text text-transparent font-bold">
            Our Journey
            </h5>
        </div>
      ...
      <div ref={ref} className="relative mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-purple-800 via-blue-800 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
