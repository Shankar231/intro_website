...
export const Navbar = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("fixed inset-x-0 top-4 z-[999] w-full", className)}>
    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        width: visible ? "min(90%, 960px)" : "100%",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-[2rem] px-4 py-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] bg-neutral-950",
            className
          )}>
          {children}
        </motion.div>
...
export const NavbarLogo = () => {
  return (
    <Link to="/" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-2xl font-normal text-blue-500 italic">
      <img src={logo} alt="Logo" className="h-10 sm:h-12 lg:h-15"/>
    </Link>
  );
};
