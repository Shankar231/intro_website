...
function handleMouseMove({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-indigo-100",
        containerClassName
      )}
      ...
      <div
        className="pointer-events-none absolute inset-0 hidden block"
        style={{
          backgroundImage: dotPatterns.default,
        }} />
      <motion.div
      ...
      <div className={cn("relative z-20 w-full flex justify-center", className)}>{children}</div>
    </div>
  );
};
