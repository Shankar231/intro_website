...
function Shape(){
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      if (window.anime && pathRef.current) {
        ...
        animationRef.current = window.anime({
          targets: [pathRef.current, glassRef.current],
          d: [
            SVG_PATHS[1],
            SVG_PATHS[2],
            SVG_PATHS[3],
          ...
          <g transform="translate(250,250)">
            <defs>
              <linearGradient id="morphGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="25%" stopColor="rgba(167, 129, 245, 0.81)" />
                <stop offset="50%" stopColor="rgba(123, 104, 238, 0.8)" />
                <stop offset="75%" stopColor="rgba(100, 80, 230, 0.6)" />
                <stop offset="100%" stopColor="rgba(72, 61, 139, 0.9)" />
              </linearGradient>
              <radialGradient id="glassGradient" cx="30%" cy="30%">
                <stop offset="0%" stopColor="rgba(255, 255, 255, 0.4)" />
                <stop offset="40%" stopColor="rgba(200, 220, 255, 0.3)" />
                <stop offset="70%" stopColor="rgba(138, 156, 255, 0.2)" />
                <stop offset="100%" stopColor="rgba(72, 61, 139, 0.1)" />
              </radialGradient>
              <filter id="glassEffect" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="2" result="blur"/>
                <feOffset in="blur" dx="2" dy="2" result="shadow"/>
                <feFlood floodColor="rgba(138, 156, 255, 0.3)" result="shadowColor"/>
              ...
              <filter id="innerGlow">
                ...
                <feFlood floodColor="rgba(200, 220, 255, 0.6)" result="glowColor"/>
